...
public class CropDashboard {
	...
	public String getFasal_type_id() {
		return fasal_type_id;
	}



	public void setFasal_type_id(String fasal_type_id) {
	...
	public CropDashboard(String typeofdata, String district_code_census, String tehsil_code_census,
			String village_code_census, String fasal_year, Integer fasal_id, String fasal_type_id, String f_description,
			Integer total_agri_area, Integer gata_count) {
		super();
		this.typeofdata = typeofdata;
		this.district_code_census = district_code_census;
		this.tehsil_code_census = tehsil_code_census;
	...
	public String toString() {
		return "CropDashboard [typeofdata=" + typeofdata + ", district_code_census=" + district_code_census
