...
public interface Khasra_fasl_1430_Model {
	...
	public Long getGata_unique_code();
	public Integer getFasal_type_id();
	public Float getAgri_area();
	public Float getAsichit_area();
	public Float getSichit_area();
