...
@Entity
@Table(name = "khasra_lock_agristack_compare")
public class Report_30_D {
		...
		public Report_30_D(Integer fasal_id, String district_code_census, String tehsil_code_census,
		...
		public String toString() {
			return "Report_30_D [fasal_id=" + fasal_id + ", district_code_census=" + district_code_census
