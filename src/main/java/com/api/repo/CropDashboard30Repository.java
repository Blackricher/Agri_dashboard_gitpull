...
import com.api.entity.CropDashboard30;
...
public interface CropDashboard30Repository extends JpaRepository<CropDashboard30, Long> {
	...
	List<CropDashboardModel30> getCropByAllDist1430(@Param("fasal_type_id") Integer fasal_type_id);
	...
	@Query(value = " select a.district_code_census,d.district_name_hindi,a.tehsil_code_census,t.tname, fasal_type_id,f_description,total_agri_area,gata_count "
			...
			+" inner join up_district_master d on d.district_code_census = a.district_code_census ", nativeQuery = true)
	List<CropDashboardModel30> getCropByTeh1430( @Param("districtCode") String districtCode,  @Param("fasal_type_id") Integer fasal_type_id);
...
//	as total_agri_area, sum(gata_count) as gata_count from cropdashboard_1430 where fasal_type_id = 1   ---- input 
//	and district_code_census='168'  ---- input
//	group by district_code_census,tehsil_code_census, fasal_type_id,f_description ) as a 
