...
import com.api.repo.CropDashboard30Repository;
...
public class CropDashboard30Service {
		...
		public List<CropDashboardModel30> getCropByAllDist1430(Integer fasal_type_id) {
			return cropDashboard30Repository.getCropByAllDist1430(fasal_type_id);
		}
		
		public List<CropDashboardModel30> getCropByTeh1430(String districtCode, Integer fasal_type_id) {
			return cropDashboard30Repository.getCropByTeh1430(districtCode, fasal_type_id);
		}
		
		public List<CropDashboardModel30> getCropByVill1430(String districtCode, String tehsilCode,Integer fasal_type_id) {
